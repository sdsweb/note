<?php
/**
 * This is the three column template used for displaying Note Widget content.
 *
 * Note will look for your-theme/note/3-col.php and load that file first if it exists.
 *
...
<?php
	...
	$template_columns = $widget->get_template_column_count( $template );
