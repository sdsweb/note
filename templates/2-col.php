<?php
/**
 * This is the two column template used for displaying Note Widget content.
 *
 * Note will look for your-theme/note/2-col.php and load that file first if it exists.
 *
