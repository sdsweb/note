<?php
/**
 * This is the four column template used for displaying Note Widget content.
 *
 * Note will look for your-theme/note/4-col.php and load that file first if it exists.
 *
