<?php
/**
 * This is the six column template used for displaying Note Widget content.
 *
 * Note will look for your-theme/note/6-col.php and load that file first if it exists.
 *
