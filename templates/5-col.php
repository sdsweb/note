<?php
/**
 * This is the five column template used for displaying Note Widget content.
 *
 * Note will look for your-theme/note/5-col.php and load that file first if it exists.
 *
